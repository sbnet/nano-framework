    ...
    */
    ...
    {    
        ...
        if(class_exists($controller) && method_exists($controller, $action))
        {
            ...
            {
                \_e("The view engine {$this->view_engine_class} doesn't exists !");
            }            
        ...
        { 
            \_e(_("Partial $module/$controller/$action not found"));
        }                
...
//        $this->i18n->reset_lang();
        ...
        {
            \_e("Not handled security error for $module_name/$controller_name/{$this->action}");
        }
        ...
        if(!$got_it)
        {
            ...
            if(class_exists($controller_name))
            {
                ...
                {        
                    ...
                    { 
                        \_e("No view found for $module_name/$controller_name/{$this->action}");
                    }        
                }            
            }
            else
